...
- Then, in the next line, declare a function named <<foo>>, followed by an opening bracket <<{>>.
...
- Then, in the next line, begin with 2 spaces, then print <<"Inside foo: myName is:">> to the output (console). Don't forget a semicolon <<;>> at the end of the line.
- Then, in the next line, begin with 2 spaces, then print <<myName>> to the output (console). Don't forget a semicolon <<;>> at the end of the line.
...
- Then, in the next line, call the function <<foo>>. Don't forget a semicolon <<;>> at the end of the line.
`;
