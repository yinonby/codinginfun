...
const md: string = `
The built-in JavaScript function <<prompt()>> instructs the browser
...
If the user clicks <<Cancel>>, the function <<prompt()>>
returns <<null>>. If the user clicks <<OK>>, the function <<prompt()>>
