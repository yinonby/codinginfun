...
Member property <<founderName>> is external, and logically never changes
(the company founder never changes). Therefore, only **read** access
should be granted outside the class.
`;
