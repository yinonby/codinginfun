...
Member property <<PERSON_LIFE_EXPECTANCY>> is not declared
read-only. Its value can change and is not an application
constant. Therefore, we should not use an uppercase system.
The property should be named <<personLifeExpectancy>>.
`;
